...
export const CVPage: React.FC<CVPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="no-print border border-[#D9D9D4] bg-[#FFFFFF] p-5 sm:p-6 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#D9D9D4] pb-4">
          ...
          <div className="inline-flex items-center space-x-1.5 px-3 py-1.5 bg-[#FAF9F7] text-[#666666] text-[11px] font-mono border border-[#D9D9D4] shrink-0">
            ...
            <span>INSTITUTIONAL FORMAT: A4 / 2-PAGE SPEC</span>
          </div>
        </div>
      ...
      <div className="print-page border border-[#D9D9D4] bg-[#FFFFFF] p-8 sm:p-12 lg:p-14 space-y-8 text-[#111111] font-sans shadow-xs">
        {/* Document Header */}
        <div className="cv-document-header border-b-2 border-[#111111] pb-5 space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-y-1.5 gap-x-3 text-xs font-mono text-[#555555] pt-1">
            ...
            <span className="text-[#D9D9D4]">•</span>
            <span>GitHub: <a href={PERSONAL_INFO.github} target="_blank" rel="noopener noreferrer" className="text-[#174A5B] hover:underline">github.com/Haidriyam</a></span>
            <span className="text-[#D9D9D4]">•</span>
        ...
        <section className="cv-section space-y-3 break-inside-avoid">
          ...
          <div className="text-xs sm:text-sm text-[#333333] space-y-2 font-sans">
            <p className="leading-relaxed">
              <strong className="text-[#174A5B]">Resilient Cyber-Physical Systems (CPS):</strong> Analyzing failure modes and attack surfaces where unauthenticated industrial protocols (Modbus-TCP, DNP3) couple with physical power converter dynamics and protection relays.
            </p>
            <p className="leading-relaxed">
              <strong className="text-[#174A5B]">Smart Grid Security &amp; Anomaly Detection:</strong> Deterministic packet inspection, state-estimation defense against false data injection (FDI), and IEC 62443 / Purdue reference architecture enforcement.
            </p>
            <p className="leading-relaxed">
              <strong className="text-[#174A5B]">Resonant Inductive Coupling:</strong> High-Q magnetic resonance link optimization, mutual inductance parameter extraction, and zero-voltage-switching (ZVS) power electronics.
            </p>
            <p className="leading-relaxed">
              <strong className="text-[#174A5B]">Distributed Testbed Infrastructure:</strong> Hardware-in-the-loop (HIL) environments, kernel-level zero-drop ring buffering, and reproducible bare-metal infrastructure orchestration.
            </p>
          </div>
        </section>
        ...
        <section className="cv-section space-y-3 break-inside-avoid">
          ...
          <div className="space-y-2.5">
            <div className="flex justify-between items-baseline text-xs sm:text-sm">
              <div>
                <span className="font-bold text-[#111111]">{EDUCATION.degree} — Power Systems</span>
            ...
            {EDUCATION.thesisOrCapstone && (
              <div className="text-xs text-[#333333] bg-[#FAF9F7] p-4 border border-[#EBEBE6] space-y-2">
        ...
        <section className="cv-section space-y-6">
          ...
          {EXPERIENCE.map((exp) => (
            <div key={exp.id} className="cv-item space-y-2.5 text-xs sm:text-sm break-inside-avoid">
              ...
              {exp.selectedContributions && (
                <div className="pt-1">
                  <span className="text-[11px] font-mono uppercase text-[#174A5B] block font-semibold mb-1.5">
                    Selected Technical Contributions:
                  </span>
                  <ul className="list-disc list-inside text-xs text-[#333333] space-y-1.5 pl-1">
        ...
        {/* 5. Selected Projects & Cyber-Physical Systems */}
        <section className="cv-section space-y-5">
          <h2 className="text-xs font-mono font-bold uppercase tracking-wider text-[#174A5B] border-b border-[#D9D9D4] pb-1.5">
            5. Selected Projects &amp; Cyber-Physical Systems
          </h2>
          <div className="space-y-4 text-xs">
            {PROJECTS.map((prj) => (
              <div key={prj.slug} className="cv-item border-l-2 border-[#174A5B] pl-4 space-y-2 break-inside-avoid">
                <div className="flex flex-wrap items-baseline justify-between gap-1">
                  <span className="font-mono font-bold text-[#111111] text-xs sm:text-sm">
                    {prj.id}: {prj.title}
                  </span>
                  <span className="font-mono text-[#8A8A85] text-xs">{prj.date}</span>
                </div>
                <div className="font-mono text-xs text-[#174A5B]">
                  Domain: {prj.domain}
                </div>
                <p className="text-[#444444] leading-relaxed">{prj.technicalSummary}</p>
                <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs font-mono text-[#666666] pt-1">
                  ...
                  {prj.repositoryUrl && (
                    <>
                      <span className="text-[#D9D9D4]">•</span>
                      <a href={prj.repositoryUrl} target="_blank" rel="noopener noreferrer" className="text-[#174A5B] hover:underline inline-flex items-center gap-1">
                        <span>GitHub / {prj.repositoryUrl.replace('https://github.com/Haidriyam/', '').replace('https://github.com/', '')}</span>
                        <ExternalLink className="w-3 h-3" />
                      </a>
                    </>
                  )}
        ...
        <section className="cv-section space-y-4">
          ...
          <div className="space-y-3.5 text-xs">
            {TECHNICAL_NOTES.map((note) => (
              <div key={note.slug} className="cv-item border-l-2 border-[#174A5B] pl-4 space-y-1.5 break-inside-avoid">
                <div className="flex flex-wrap items-baseline gap-2">
                  <span className="font-mono font-bold text-[#174A5B]">[{note.id}]</span>
                  <span className="font-sans font-bold text-[#111111] text-xs sm:text-sm">"{note.title}"</span>
                </div>
        ...
        <section className="cv-section space-y-3.5 break-inside-avoid">
          <h2 className="text-xs font-mono font-bold uppercase tracking-wider text-[#174A5B] border-b border-[#D9D9D4] pb-1.5">
            7. Technical Competencies
          </h2>
        ...
        <section className="cv-section space-y-3.5 break-inside-avoid">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs font-mono">
            {CREDENTIALS.map((cred) => (
              <div key={cred.id} className="cv-item p-3 border border-[#D9D9D4] bg-[#FAF9F7] flex items-center justify-between">
                <div>
                  <span className="font-bold text-[#174A5B] block text-xs">{cred.issuer}</span>
        ...
        <div className="cv-document-footer pt-4 border-t border-[#D9D9D4] text-xs font-mono text-[#666666] leading-relaxed">
          <span className="font-bold text-[#111111]">REFERENCES &amp; INSTITUTIONAL VALIDATION: </span>
          <span>
